...
-->
<head>
<title>400 - Ошибка выполнения кода</title>
...
<body class="bg-purple">
        ...
        <div class="stars">
            ...
            <div class="central-body">
                <h1>400 - Ошибка выполнения кода</h1>
                <h2>Код не может быть обработан, так как произошла ошибка в "<?php
                $error = $_GET['error'];
                echo $error; ?>" на этой странице: <?php
                $url = $_GET['url'];
                echo $url; ?></h2>
